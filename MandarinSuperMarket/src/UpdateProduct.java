...
public class UpdateProduct extends JDialog {
	...
	private JTextField textField_1;String price,item;
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						item=textField.getText();
						 ...
						 System.out.println("price="+price);Double x=Double.parseDouble(price);System.out.println("double="+x);
						try{
							
							// ps=ob.con.prepareStatement("update Products SET Price=? where Item=?;");
						PreparedStatement ps1=(PreparedStatement) ob.con.prepareStatement("update Products SET Price=? where Item=?;");
						
						ps1.setDouble(1, x);
						ps1.setString(2, item);
						int i=ps1.executeUpdate();
						if(i>0){JOptionPane.showMessageDialog(null, "Updated Successfully !");}
